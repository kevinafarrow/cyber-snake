    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			div3.innerHTML = `<div class="food1 svelte-era8ti"></div> 
      <div class="food2 svelte-era8ti"></div>`;

    			t3 = space();
    			div6 = element("div");
    			div4 = element("div");
    			t4 = text(/*option1*/ ctx[1]);
    			t5 = space();
    			div5 = element("div");
    			t6 = text(/*option2*/ ctx[2]);
    			attr(div0, "class", "question svelte-era8ti");
    			attr(div3, "class", "food");
    			attr(div4, "class", "option1 svelte-era8ti");
    			attr(div5, "class", "option2 svelte-era8ti");
    			attr(div6, "class", "option");
    			attr(div7, "class", "grid-container svelte-era8ti");
    			attr(div8, "class", "questionbox svelte-era8ti");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*option1*/ 2) set_data(t4, /*option1*/ ctx[1]);
