var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "class", "food svelte-924afp");
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h1, "class", "svelte-1kujkxi");
    			attr(main, "class", "svelte-1kujkxi");
    		},
    		m(target, anchor, remount) {
    			...
    			current = true;
    			if (remount) dispose();
    			dispose = listen(window, "keydown", /*onKeyDown*/ ctx[4]);
    		},
    		p(ctx, [dirty]) {
    			const snake_changes = {};
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function moveFood() {
    		$$invalidate(1, foodTop = Math.floor(Math.random() * Math.floor(board.height / unit$1)) * unit$1);
    		$$invalidate(0, foodLeft = Math.floor(Math.random() * Math.floor(board.width / unit$1)) * unit$1);
    	}
    	...
    	resetGame();
    	return [foodLeft, foodTop, direction, snakeBodies, onKeyDown];
    }
