var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "result svelte-1j0iev8");
    			attr(div1, "class", "explanation svelte-1j0iev8");
    			attr(div2, "class", "answerbox svelte-1j0iev8");
    		},
    		m(target, anchor) {
    			insert(target, div2, anchor);
    			append(div2, div0);
    ...
    function create_fragment$5(ctx) {
    	...
    	let h2;
    	let t6;
    	let t7_value = /*snakeBodies*/ ctx[10].length - 3 + "";
    	let t7;
    	let current;
    	let dispose;
    	...
    	return {
    		c() {
    			...
    			t6 = text("Score: ");
    			t7 = text(t7_value);
    			attr(h1, "class", "svelte-lmypyc");
    			attr(div, "class", "prompt svelte-lmypyc");
    			attr(main, "class", "svelte-lmypyc");
    			attr(h2, "class", "svelte-lmypyc");
    		},
    		m(target, anchor, remount) {
    			insert(target, h1, anchor);
    			insert(target, t1, anchor);
    			insert(target, div, anchor);
    			mount_component(questionbox, div, null);
    			append(div, t2);
    			mount_component(answerbox, div, null);
    			insert(target, t3, anchor);
    		...
    		p(ctx, dirty) {
    			...
    			if ((!current || dirty[0] & /*snakeBodies*/ 1024) && t7_value !== (t7_value = /*snakeBodies*/ ctx[10].length - 3 + "")) set_data(t7, t7_value);
    		},
    		i(local) {
    			if (current) return;
